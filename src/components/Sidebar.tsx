    ...
    <div className={`${styles.sidebar} ${isExpanded ? styles.expanded : ""}`}>
      ...
      >
        <div>
          ...
          <Collapse>
            <p>{`"Dans toute vie nous trouverions des continents, des îles, des déserts, des marais, des territoires surpeuplés et des *terrae incognitae*. 
...
et des contours pour dresser ses cartes." — Chris Marker, Immemory`}</p>
          </Collapse>
